package com.name.microservice.care.carecontroller.api;
...
public class CareController extends BaseClass {
    ...
    final private String Sc_DOCTOR_PRICE = "/cares/scCode/{scCode}/doctors/price";
    ...
    public CareSearchResponse careSearch(CareSearchRequest careSearchRequest, String token) {
        ...
        addNonEmptyStringQueryParam(reqSpec, "scCode", careSearchRequest.getScCode());
        ...
        addNonNegativeNumberQueryParam(reqSpec, "scPercentage", careSearchRequest.getScPercentage());
