package com.name.microservice.partner.partnercontroller.tests;

import com.name.microservice.baseclass.BaseClass;
import com.name.microservice.partner.partnercontroller.api.PartnerController;
import com.name.microservice.partner.partnercontroller.dto.response.GetValidateEmail;
import com.name.microservice.partner.partnercontroller.dto.response.GetValidateUrl;
