...
import com.name.microservice.doctor.careRate.dto.request.DoctorPartnersRateCaresDoctorsRequest;
import com.name.microservice.doctor.careRate.dto.request.DoctorPartnersRateRequest;
import com.name.microservice.doctor.careRate.dto.request.DoctorRatesRequest;
import com.name.microservice.doctor.careRate.dto.request.RatesCareDoctorsRequest;
import com.name.microservice.doctor.careRate.dto.request.RatesEntriesRequest;
...
public class CareRateController extends BaseClass {
    ...
    public Response partnersRatesCaresDoctors(DoctorPartnersRateCaresDoctorsRequest doctorPartnersRateCaresDoctorsRequest, String token) {
        ...
        addNonEmptyStringQueryParam(reqSpec, "csCode", doctorPartnersRateCaresDoctorsRequest.getScCode());
    ...
    public Response ratesCaresDoctors(RatesCareDoctorsRequest ratesCareDoctorsRequest, String token) {
        ...
        addNonEmptyStringQueryParam(reqSpec, "scCode", ratesCareDoctorsRequest.getScCode());
    ...
    public Response ratesEntries(RatesEntriesRequest ratesEntriesRequest, String token) {
        ...
        addNonEmptyStringQueryParam(reqSpec, "scCode", ratesEntriesRequest.getScFCode());
