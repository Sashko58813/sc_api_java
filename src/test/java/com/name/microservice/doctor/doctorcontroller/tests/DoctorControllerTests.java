package com.name.microservice.doctor.doctorcontroller.tests;
...
import com.name.microservice.doctor.doctorcontroller.api.DoctorController;
import com.name.microservice.doctor.doctorcontroller.data.DoctorControllerData;
import com.name.microservice.doctor.doctorcontroller.data.DoctorDetail1285716969;
import com.name.microservice.doctor.doctorcontroller.dto.DoctorDTO;
import com.name.microservice.doctor.doctorcontroller.dto.DoctorDetailResponse;
import com.name.microservice.doctor.doctorcontroller.dto.DoctorResponse;
import com.name.microservice.doctor.doctorcontroller.dto.DoctorSearchFilterResponse;
import com.name.microservice.doctor.doctorcontroller.dto.DoctorSuggestResponse;
import com.name.microservice.doctor.doctorcontroller.dto.DoctorsDetailRequest;
import com.name.microservice.doctor.doctorcontroller.dto.DoctorsRequest;
import com.name.microservice.doctor.doctorcontroller.dto.DoctorsSuggestRequest;
