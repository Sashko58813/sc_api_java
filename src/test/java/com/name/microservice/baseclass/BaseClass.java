package com.name.microservice.baseclass;
...
public class BaseClass {
    ...
    public static String adminUsername = "oali@sc.com";
    ...
    public void setup(@Optional("qa") String env) {
        if (env.equalsIgnoreCase(("qa")) || env.equals(" ")) {
            RestAssured.baseURI = "https://qa-api.sc.com";
            System.setProperty("test.env", "qa");
        } else if (env.equalsIgnoreCase(("hotfix"))) {
            RestAssured.baseURI = "https://hotfix-api.sc.com";
            System.setProperty("test.env", "hotfix");
        } else if (env.equalsIgnoreCase(("dev"))) {
            RestAssured.baseURI = "https://dev-api.sccom";
